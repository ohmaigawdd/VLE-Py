...
def realreactors():
    ...
    return render_template("realreactors.html", form=form, errors=errors, reactorType=reactorType, problemType=problemType, bypassdeadvolume = bypassdeadvolume, idealsystem=idealsystem, realsystem=realsystem, Cgraph=Cgraph, realCgraph=realCgraph, realEgraph=realEgraph, realFgraph=realFgraph)
